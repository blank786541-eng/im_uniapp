...
export interface JoinOptions {
  ...
  /**
   * 是否开启远端音频流混流。默认为 false。注意，开启远端音频流混流后，remoStream仅支持部分接口。
   */
  mixRemoteAudioStream?: boolean
}
...
export interface HitLocationInfos {
  //打码的原因描述
  hitInfo: string
  //打码的区域坐标
  x1: number
...
export interface enableAIDenoiseOptions {
  /**
   * 是否开启啸叫消除，默认关闭
   */
  howlingSuppressionEnable?: boolean
}
