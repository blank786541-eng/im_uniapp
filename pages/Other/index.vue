<script src="../../../G2-API-Examples/web/sampleCode-Vue/H5VideoCall-Web-Vue/src/common/index.js"></script>
<template>
  <div class="wrapper">
    <!--画面div-->
...
export default {
  ...
  mounted() {
    ...
    this.client = NERTC.createClient({
      appkey:  '144706c24be1b1cc44180fb7cf3bca9e',
      debug: true,
    });
    //监听事件
  ...
  async destroyed() {
    try {
      clearInterval(this.localAudioStatsInterval);
      clearInterval(this.localVideoStatsInterval);
  ...
  methods: {
    ...
    getLocalVideoStats() {
      this.localVideoStatsInterval = setInterval(async () => {
        try {
